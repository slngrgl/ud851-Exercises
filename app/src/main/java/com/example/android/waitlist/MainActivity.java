...
public class MainActivity extends AppCompatActivity {
    ...
    public void addToWaitlist(View view) {
        ...
        try {
            ...
            Log.e(LOG_TAG, "Failed to parse party size string to int: " + ex.getMessage());
        }
    ...
    private long addGuest(String name, int partySize) {
        ...
        // TOCOMPLETEDDO (8) call insert to run an insert query on TABLE_NAME with the ContentValues created
